...
const dict: Record<string, Record<Lang, string>> = {
  ...
  scrollMeta: { zh: "滚动当前豆包页，补全长对话完整历史", en: "Scroll to capture the full conversation history" },
  scrollAlert1: { zh: "请在豆包对话页使用此功能", en: "Please use this feature on a Doubao chat page" },
  scrollAlert2: { zh: "滚动失败，请确认当前页是豆包对话页且已加载扩展", en: "Scroll failed. Please ensure this is a Doubao chat page and the extension is loaded" },
